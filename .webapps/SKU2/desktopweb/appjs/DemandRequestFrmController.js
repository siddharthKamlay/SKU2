    ...
    AS_Form_c9d44fb4d5ad4928932f0eeb9e353e07: function AS_Form_c9d44fb4d5ad4928932f0eeb9e353e07(eventobject) {
        ...
        function INVOKE_SERVICE_jaeb26165b184047aca6d7d11e45e1aa_Callback(DemandRequest) {
            ...
            if (DemandRequest.opstatus == 0) {
                ...
                var tempCollection9901 = [];
                var tempData4574 = DemandRequest.records;
                for (var each5067 in tempData4574) {
                    var shouldShow = typeof tempData4574[each5067]["x_0024FILES"] !== 'undefined' && tempData4574[each5067]["x_0024FILES"] && tempData4574[each5067]["x_0024FILES"].length > 0
                    tempCollection9901.push({
                        "lblSKUID": {
                            "text": tempData4574[each5067]["SKUID"]
                        },
                        "lblName": {
                            "text": tempData4574[each5067]["Name"]
                        },
                        "lblCategory": {
                            "text": tempData4574[each5067]["Category"]
                        },
                        "lblStock": {
                            "text": tempData4574[each5067]["Stock"]
                        },
                        "lblForecasted": {
                            "text": tempData4574[each5067]["Forecasted"]
                        },
                        "lblEnrichedQTY": {
                            "text": tempData4574[each5067]["EnrichedQTY"]
                        },
                        "lblRequested": {
                            "text": tempData4574[each5067]["Requested"]
                        },
                        "lblStatus": {
                            "text": tempData4574[each5067]["Status"]
                        },
                        "lblRequestedBY": {
                            "text": tempData4574[each5067]["RequestedBY"]
                        },
                        "lblRequestDate": {
                            "text": tempData4574[each5067]["RequestDate"]
                        },
                    });
                }
                self.view.segDemandRequest.setData(tempCollection9901);

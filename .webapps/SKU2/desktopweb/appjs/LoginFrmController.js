...
define("LoginFrmControllerActions", {
    ...
    */
    ...
    AS_Button_je7479732d18461f8a986160b7b3c4c0: function AS_Button_je7479732d18461f8a986160b7b3c4c0(eventobject) {
        ...
        function INVOKE_SERVICE_addf556c7d5043ac99843f6154b8ad62_Success(response) {
        ...
        function INVOKE_SERVICE_addf556c7d5043ac99843f6154b8ad62_Failure(error) {
            voltmx.application.dismissLoadingScreen();

            function SHOW_ALERT_idcf18bf49614274ad1d2a54d62775c5_Callback() {
                SHOW_ALERT_idcf18bf49614274ad1d2a54d62775c5_True();
            }
            voltmx.ui.Alert({
                ...
                "alertHandler": SHOW_ALERT_idcf18bf49614274ad1d2a54d62775c5_Callback
            }, {
                "iconPosition": constants.ALERT_ICON_POSITION_LEFT
            });
        }

        function SHOW_ALERT_idcf18bf49614274ad1d2a54d62775c5_True() {}
        ...
        LoginAuthentication$login = mfidentityserviceinvoker("LoginAuthentication", login_inputparam, INVOKE_SERVICE_addf556c7d5043ac99843f6154b8ad62_Success, INVOKE_SERVICE_addf556c7d5043ac99843f6154b8ad62_Failure);
    }
});

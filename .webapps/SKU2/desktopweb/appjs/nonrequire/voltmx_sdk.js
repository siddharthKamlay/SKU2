 ...
 voltmx.sdk.prototype.init = function(appKey, appSecret, serviceUrl, successCallback, failureCallback, initOptions) {
     ...
     populateHeaderWithVanityUrl(headers);
     if (!voltmx.sdk.isNullOrUndefined(appConfig) && !voltmx.sdk.isNullOrUndefined(appConfig.offlineDB) && !voltmx.sdk.isNullOrUndefined(voltmx) && !voltmx.sdk.isNullOrUndefined(voltmx.model) && !voltmx.sdk.isNullOrUndefined(voltmx.model.constants) && !voltmx.sdk.isNullOrUndefined(voltmx.model.constants.DesktopNativeOfflineDB) && appConfig.offlineDB === voltmx.model.constants.DesktopNativeOfflineDB.SQLITE) {
 ...
 function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
     ...
     function appendDecodedCustomOAuthParamsToURLiOS(url) {
         var decodedCustomQueryParamsForOAuth = decodeURIComponent(customQueryParamsForOAuth);
         if (!voltmx.sdk.util.isNullOrEmptyString(decodedCustomQueryParamsForOAuth)) {
             url = url + "&" + decodedCustomQueryParamsForOAuth;
         }
         return url;
     }
     ...
     if (typeof(XMLHttpRequest) !== 'undefined') {
         ...
         if (isLogout) {
             ...
             if (voltmx.sdk.getPlatformName() == voltmx.sdk.constants.PLATFORM_IOS) {
                 requestUrl = appendDecodedCustomOAuthParamsToURLiOS(requestUrl);
             } else {
 ...
 voltmx.setupsdks = function(initConfig, successCallBack, errorCallBack) {
     ...
     function getAppConfigFromCache() {
         ...
         if (!voltmx.sdk.isNullOrUndefined(dsAppMetaData)) {
             if (voltmx.sdk.util.isAppConfigEncrypted()) {
                 ...
                 if (!voltmx.sdk.isNullOrUndefined(appKey) || !voltmx.sdk.isNullOrUndefined(appSecret) || !voltmx.sdk.isNullOrUndefined(serviceUrl) || !voltmx.sdk.isNullOrUndefined(vanityUrl) || !voltmx.sdk.isNullOrUndefined(dsAppServiceDoc)) {
     ...
     if (!voltmx.sdk.isNullOrUndefined(initConfig) && !voltmx.sdk.isNullOrUndefined(initConfig.appConfig) && !voltmx.sdk.isNullOrUndefined(initConfig.appConfig.offlineDB) && !voltmx.sdk.isNullOrUndefined(voltmx) && !voltmx.sdk.isNullOrUndefined(voltmx.model) && !voltmx.sdk.isNullOrUndefined(voltmx.model.constants) && !voltmx.sdk.isNullOrUndefined(voltmx.model.constants.DesktopNativeOfflineDB) && initConfig.appConfig.offlineDB === voltmx.model.constants.DesktopNativeOfflineDB.SQLITE) {
         voltmx.sdk.util.useSQLite = true;
     } else {
         voltmx.sdk.util.useSQLite = false;
     }
 ...
 */
 ...
 function voltmxNetHttpRequest(url, params, headers, httpMethod, voltmxContentType, successCallback, failureCallback, options) {
     ...
     function localRequestCallback(result) {
         ...
         if (readyState === 4) {
             try {
                 // Ensure the response exists before processing
                 if (result.response) {
                 ...
                 voltmx.sdk.logsdk.error("Error parsing response:" + JSON.stringify(e));
             }
 ...
 voltmx.sdk.util.loadMetadataFromDs = function(dsAppMetaData, dsAppServiceDoc) {
     ...
     if (voltmx.sdk.util.isAppConfigEncrypted()) {
         if (!voltmx.sdk.isNullOrUndefined(dsAppMetaData)) {
             ...
             var appSecret = voltmx.sdk.util.decryptAppConfig(dsAppMetaData.appSecret);
             var serviceUrl = voltmx.sdk.util.decryptAppConfig(dsAppMetaData.serviceUrl);
             var vanityUrl = voltmx.sdk.isNullOrUndefined(dsAppMetaData.vanityUrl) ? null : voltmx.sdk.util.decryptAppConfig(dsAppMetaData.vanityUrl);

...
async function copyPWAFiles(props) {
    ...
    if(!props.enableProgressiveWeb) {
        ...
        await replaceServiceWorkerExt(loc.opWebappsPath(props)+'/temp/sw-ext.js', props.cacheId, props.enablePushNotificationsDW, props.fcmSenderId, props.fcmApiKey, props.fcmProjectId, props.fcmAppId);
    }
}
...
async function replaceServiceWorkerExt(file, cacheId, enablePushNotificationsDW, fcmsenderid, fcmapikey, fcmprojectid, fcmappid) {
    ...
    if(enablePushNotificationsDW) {
        ...
        replaceTokensVal['@fcmapikey@'] = fcmapikey;
        replaceTokensVal['@fcmprojectid@'] = fcmprojectid;
        replaceTokensVal['@fcmappid@'] = fcmappid;
    } else {
        replaceTokensVal['@fcmsenderid@'] = '';
        replaceTokensVal['@fcmapikey@'] = '';
        replaceTokensVal['@fcmprojectid@'] = '';
        replaceTokensVal['@fcmappid@'] = '';
    }

    ...
    var module = {
        ...
        renderChildren: function(flexModel, wArrary, context) {
            ...
            for(var i = 0; i < wArrary.length; i++) {
                ...
                && !$KW.Utils.getActualWidgetModel(wArrary[i]).clipbounds) || (childModel.wType == "Label" && childModel.width == "preferred")) {
        ...
        adjustFlexContainers: function(containerModel, containerNode) {
            ...
            if(containerModel.wType == 'CollectionView') {
                ...
                $KW.DataGrid.adjustFlexContainersInDataGrid(containerModel, containerNode);
            } else if(containerModel.wType == 'TabPane') {
                $KW.TabPane.adjustFlexContainersInTab(containerModel, containerNode);
            }
        },
        ...
        addChildat: function(boxModel, wArray, index, counter) {
            ...
            if(box) {
                ...
                if(typeof counter !== 'undefined') {
                    box.insertBefore(wrapper.childNodes[0], box.childNodes[counter]);
                }
                else {
                    box.insertBefore(wrapper.childNodes[0], box.childNodes[index]);
                }

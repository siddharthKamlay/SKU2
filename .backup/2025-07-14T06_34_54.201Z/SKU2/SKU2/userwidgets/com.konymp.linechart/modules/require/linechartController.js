          	...
          	defineSetter(this, "lineColor", function(val) {
              	...
              	try {
                  	if(this.hexCodeFormat.test(val)) {
                      	...
                      	throw {"Error": "InvalidLineColorCode", "message": "The color code must be in hex format. Eg.:#000000"};
                    }
                }
              	catch(exception) {
          	...
          	defineSetter(this, "titleFontColor", function(val) {
              	...
              	try {
                  	if(this.hexCodeFormat.test(val)) {
                      	...
                      	throw {"Error": "InvalidTitleFontColorCode", "message": "The color code must be in hex format. Eg.:#000000"};
                    }
                }
              	catch(exception) {
                  	konymp.logger.error(JSON.stringify(exception), konymp.logger.EXCEPTION);
          	...
          	defineSetter(this, "bgColor", function(val) {
              	...
              	try {
                  	if(this.hexCodeFormat.test(val)) {
                      	...
                      	throw {"Error": "InvalidBackgoundColorCode", "message": "The color code must be in hex format. Eg.:#000000"};
                    }
                }
              	catch(exception) {
                  	konymp.logger.error(JSON.stringify(exception), konymp.logger.EXCEPTION);
      	...
      	validateAllParams: function(title, labels, series, properties) {
      		...
      		try {
      			...
      			if(!this.validateData(properties._lineColor, 'string')) {
        			throw {"Error": "Invalid Datatype", "message": "Wrong dataType for lineColor " + JSON.stringify(properties._lineColor)};
      			}
          		...
          		if(!this.validateData(properties._bgColor, 'string')) {
              		throw {"Error": "Invalid Datatype", "message": "Wrong dataType for backgroundColor " + JSON.stringify(properties._bgColor)};
            	}
            }
          	catch(exception) {
              	konymp.logger.error(JSON.stringify(exception), konymp.logger.EXCEPTION);

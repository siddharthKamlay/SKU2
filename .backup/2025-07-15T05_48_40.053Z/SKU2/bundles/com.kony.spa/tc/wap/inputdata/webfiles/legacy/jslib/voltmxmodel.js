voltmx.model = (function() {
    ...
    var module = {
        ...
        getWidgetModel: function(formID, widgetID, immediateParentID) {
            ...
            if(widgetID && formID != widgetID && formModel) {
        ...
        getWidgetRef: function(widgetID) {
            ...
            if(obj && ["Form", "Form2"].contains(obj.wType))
                ...
                return($KG[widgetID] || window[widgetID] || $KU.getTemplateModel(widgetID, appName) || ($KG["__currentForm"] && $KG["__currentForm"][widgetID]));
        }
    };

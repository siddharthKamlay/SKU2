...
(function() {
    ...
    $KU.defineProperty(voltmx.application, 'addContextMenuItems', function() {
        _notSupported('voltmx.application.addContextMenuItems');
    });
    $KU.defineProperty(voltmx.application, 'removeContextMenuItems', function() {
        _notSupported('voltmx.application.removeContextMenuItems');
    });
    $KU.defineProperty(voltmx.application, 'removeContextMenu', function() {
        _notSupported('voltmx.application.removeContextMenu');
    });

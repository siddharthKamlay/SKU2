...
(function(tcc) {
    ...
    tcc.generateIndexForSPA = function(cgArgs) {
        ...
        if(fs.existsSync(outputdir)) {
            ...
            indexMap['packageAsPortlet'] = cgArgs.packageAsPortlet;
            ...
            if(platform == "desktopweb") {
                ...
                if(enablepush && enablepwa) {
                    // Updated Firebase app compatibility library and messaging compatibility library.
                    importjsfiles.push("https://www.gstatic.com/firebasejs/9.2.0/firebase-app-compat.js");
                    importjsfiles.push("https://www.gstatic.com/firebasejs/9.2.0/firebase-messaging-compat.js"); 
                }
            }
